...
def run_a_example(input_str, output_str, enable_profiling=False, c_profiler=None, l_profiler=None):
    assert(not enable_profiling or (
        enable_profiling and c_profiler and l_profiler))
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "-p":
        try:
            ...
            print("Warning: Profiling librarie not available. Use `pip install line_profiler`" +
